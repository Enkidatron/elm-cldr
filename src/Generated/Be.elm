...
be =
    Internal.Locale.Locale
        { languageId = Lang (Tagged.tag "be") Nothing Nothing Nothing
        , monthFormatNames =
            { abbreviated =
                { jan = "сту"
                , feb = "лют"
        ...
        , eraNames =
            ...
            , wide =
                { bc = "да нараджэння Хрыстова", ad = "ад нараджэння Хрыстова" }
        ...
        , dateTimeTokens =
            ...
            , long =
                [ DateGoesHere, Text " ", Text "у", Text " ", TimeGoesHere ]
            , full =
                [ DateGoesHere, Text " ", Text "у", Text " ", TimeGoesHere ]
            }
        , availableFormats =
...
be_TARASK =
    Internal.Locale.Locale
        { languageId =
            Lang (Tagged.tag "be") Nothing Nothing (Just (Tagged.tag "TARASK"))
        , monthFormatNames =
            { abbreviated =
                { jan = "сту"
                , feb = "лют"
