...
hr =
    Internal.Locale.Locale
        { languageId = Lang (Tagged.tag "hr") Nothing Nothing Nothing
        , monthFormatNames =
            { abbreviated =
                { jan = "sij"
                , feb = "velj"
        ...
        , dayPeriodRuleSet = hr_dayPeriodRules
        , dateSymbols =
            { short =
...
hr_BA =
    Internal.Locale.Locale
        { languageId =
            Lang (Tagged.tag "hr") Nothing (Just (Tagged.tag "BA")) Nothing
        , monthFormatNames =
            { abbreviated =
                { jan = "sij"
                , feb = "velj"
...
hr_dayPeriodRules : List Internal.DayPeriodRule.DayPeriodRule
hr_dayPeriodRules =
