...
-}
    ...
    Internal.Locale.Locale
        { languageId = Lang (Tagged.tag "fi") Nothing Nothing Nothing
        , monthFormatNames =
            { abbreviated =
                { jan = "tammik."
                , feb = "helmik."
        ...
        , dayPeriodRuleSet = fi_dayPeriodRules
        , dateSymbols =
            { short =
            ...
            , full =
                [ Sym.Symbol (Sym.WeekdayStandalone Sym.Wide)
                , Sym.Literal " "
                , Sym.Symbol (Sym.Day Sym.MinimumDigits)
                , Sym.Literal ". "
                , Sym.Symbol (Sym.Month (Sym.Text Sym.Wide))
...
fi_dayPeriodRules : List Internal.DayPeriodRule.DayPeriodRule
fi_dayPeriodRules =
