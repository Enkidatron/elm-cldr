        ...
        Just
            (Internal.PluralRule.Or
                (Internal.PluralRule.And
                    ...
                    , modBy = Nothing
                    , operator = Internal.PluralRule.Equals
                    , target = ( Internal.PluralRule.Exactly 3, [] )
                    }
                    []
                )
                []
        ...
        Just
            (Internal.PluralRule.Or
                (Internal.PluralRule.And
                    ...
                    , modBy = Nothing
                    , operator = Internal.PluralRule.Equals
                    , target = ( Internal.PluralRule.Exactly 6, [] )
                    }
                    []
                )
                []
