...
lt =
    Internal.Locale.Locale
        { languageId = Lang (Tagged.tag "lt") Nothing Nothing Nothing
        , monthFormatNames =
            { abbreviated =
                { jan = "saus."
                , feb = "vas."
        ...
        , dayPeriodRuleSet = lt_dayPeriodRules
        , dateSymbols =
            { short =
        ...
        , availableFormats =
            ...
            , Internal.Locale.DateAF
                ...
                , formatSymbols = [ Sym.Symbol (Sym.Day Sym.TwoDigit) ]
                }
            , Internal.Locale.DateAF
                { options =
                    { era = Nothing
...
lt_dayPeriodRules : List Internal.DayPeriodRule.DayPeriodRule
lt_dayPeriodRules =
