...
ur =
    Internal.Locale.Locale
        { languageId = Lang (Tagged.tag "ur") Nothing Nothing Nothing
        , monthFormatNames =
            { abbreviated =
                { jan = "جنوری"
                , feb = "فروری"
        ...
        , dayPeriodRuleSet = ur_dayPeriodRules
        , dateSymbols =
            { short =
...
ur_IN =
    Internal.Locale.Locale
        { languageId =
            Lang (Tagged.tag "ur") Nothing (Just (Tagged.tag "IN")) Nothing
        , monthFormatNames =
            { abbreviated =
                { jan = "جنوری"
                , feb = "فروری"
...
ur_dayPeriodRules : List Internal.DayPeriodRule.DayPeriodRule
ur_dayPeriodRules =
