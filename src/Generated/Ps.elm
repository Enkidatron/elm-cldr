...
ps =
    Internal.Locale.Locale
        { languageId = Lang (Tagged.tag "ps") Nothing Nothing Nothing
        , monthFormatNames =
            { abbreviated =
                { jan = "جنوري"
                , feb = "فبروري"
        ...
        , eraNames =
            ...
            , wide = { bc = "له میلاد څخه وړاندې", ad = "له میلاد څخه وروسته" }
            , narrow = { bc = "له میلاد وړاندې", ad = "م." }
            }
        , periodNames =
            { abbreviated =
                { am = "غ.م.", pm = "غ.و.", dayPeriods = Dict.fromList [] }
            , wide = { am = "غ.م.", pm = "غ.و.", dayPeriods = Dict.fromList [] }
            , narrow =
                { am = "غ.م.", pm = "غ.و.", dayPeriods = Dict.fromList [] }
            }
        , dayPeriodRuleSet = []
...
ps_PK =
    Internal.Locale.Locale
        { languageId =
            Lang (Tagged.tag "ps") Nothing (Just (Tagged.tag "PK")) Nothing
        , monthFormatNames =
            { abbreviated =
                { jan = "جنوري"
                , feb = "فبروري"
