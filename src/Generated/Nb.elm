...
nb =
    Internal.Locale.Locale
        { languageId = Lang (Tagged.tag "nb") Nothing Nothing Nothing
        , monthFormatNames =
            { abbreviated =
                { jan = "jan."
                , feb = "feb."
        ...
        , dayPeriodRuleSet = nb_dayPeriodRules
        , dateSymbols =
            { short =
        ...
        , dateTimeTokens =
            ...
            , long =
                [ DateGoesHere, Text " ", Text "kl", Text ". ", TimeGoesHere ]
            , full =
                [ DateGoesHere, Text " ", Text "kl", Text ". ", TimeGoesHere ]
            }
        , availableFormats =
...
nb_SJ =
    Internal.Locale.Locale
        { languageId =
            Lang (Tagged.tag "nb") Nothing (Just (Tagged.tag "SJ")) Nothing
        , monthFormatNames =
            { abbreviated =
                { jan = "jan."
                , feb = "feb."
...
nb_dayPeriodRules : List Internal.DayPeriodRule.DayPeriodRule
nb_dayPeriodRules =
