...
ta =
    Internal.Locale.Locale
        { languageId = Lang (Tagged.tag "ta") Nothing Nothing Nothing
        , monthFormatNames =
            { abbreviated =
                { jan = "ஜன."
                , feb = "பிப்."
        ...
        , dayPeriodRuleSet = ta_dayPeriodRules
        , dateSymbols =
            { short =
...
ta_LK =
    Internal.Locale.Locale
        { languageId =
            Lang (Tagged.tag "ta") Nothing (Just (Tagged.tag "LK")) Nothing
        , monthFormatNames =
            { abbreviated =
                { jan = "ஜன."
                , feb = "பிப்."
...
ta_MY =
    Internal.Locale.Locale
        { languageId =
            Lang (Tagged.tag "ta") Nothing (Just (Tagged.tag "MY")) Nothing
        , monthFormatNames =
            { abbreviated =
                { jan = "ஜன."
                , feb = "பிப்."
...
ta_SG =
    Internal.Locale.Locale
        { languageId =
            Lang (Tagged.tag "ta") Nothing (Just (Tagged.tag "SG")) Nothing
        , monthFormatNames =
            { abbreviated =
                { jan = "ஜன."
                , feb = "பிப்."
...
ta_dayPeriodRules : List Internal.DayPeriodRule.DayPeriodRule
ta_dayPeriodRules =
