...
af =
    Internal.Locale.Locale
        { languageId = Lang (Tagged.tag "af") Nothing Nothing Nothing
        , monthFormatNames =
            { abbreviated =
                { jan = "Jan."
                , feb = "Feb."
        ...
        , dayPeriodRuleSet = af_dayPeriodRules
        , dateSymbols =
            { short =
...
af_NA =
    Internal.Locale.Locale
        { languageId =
            Lang (Tagged.tag "af") Nothing (Just (Tagged.tag "NA")) Nothing
        , monthFormatNames =
            { abbreviated =
                { jan = "Jan."
                , feb = "Feb."
...
af_dayPeriodRules : List Internal.DayPeriodRule.DayPeriodRule
af_dayPeriodRules =
