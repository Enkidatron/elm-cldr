...
yue =
    Internal.Locale.Locale
        { languageId = Lang (Tagged.tag "yue") Nothing Nothing Nothing
        , monthFormatNames =
            { abbreviated =
                { jan = "1月"
                , feb = "2月"
        ...
        , dayPeriodRuleSet = yue_dayPeriodRules
        , dateSymbols =
            { short =
...
yue_Hant =
    Internal.Locale.Locale
        { languageId =
            Lang (Tagged.tag "yue") (Just (Tagged.tag "Hant")) Nothing Nothing
        , monthFormatNames =
            { abbreviated =
                { jan = "1月"
                , feb = "2月"
...
yue_dayPeriodRules : List Internal.DayPeriodRule.DayPeriodRule
yue_dayPeriodRules =
